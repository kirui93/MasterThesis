...
\CommentTok{# Calculate the number of loops based on how high to vary the risk premium and by what increment}
\NormalTok{loops <-}\StringTok{ }\NormalTok{risk.premium.up }\OperatorTok{/}\StringTok{ }\NormalTok{risk.increment }\OperatorTok{+}\StringTok{ }\DecValTok{1}
\NormalTok{loop <-}\StringTok{ }\DecValTok{1}
 
\CommentTok{# Initialize a matrix to contain allocation and statistics}
\CommentTok{# This is not necessary, but speeds up processing and uses less memory}
\NormalTok{eff <-}\StringTok{ }\KeywordTok{matrix}\NormalTok{(}\DataTypeTok{nrow=}\NormalTok{loops, }\DataTypeTok{ncol=}\NormalTok{n}\OperatorTok{+}\DecValTok{3}\NormalTok{)}
\CommentTok{# Now I need to give the matrix column names}
\KeywordTok{colnames}\NormalTok{(eff) <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\KeywordTok{colnames}\NormalTok{(returns), }\StringTok{"Std.Dev"}\NormalTok{, }\StringTok{"Exp.Return"}\NormalTok{, }\StringTok{"sharpe"}\NormalTok{)}
 
\CommentTok{# Loop through the quadratic program solver}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \KeywordTok{seq}\NormalTok{(}\DataTypeTok{from=}\DecValTok{0}\NormalTok{, }\DataTypeTok{to=}\NormalTok{risk.premium.up, }\DataTypeTok{by=}\NormalTok{risk.increment))\{}
\NormalTok{dvec <-}\StringTok{ }\KeywordTok{colMeans}\NormalTok{(returns) }\OperatorTok{*}\StringTok{ }\NormalTok{i }\CommentTok{# This moves the solution up along the efficient frontier}
\NormalTok{sol <-}\StringTok{ }\KeywordTok{solve.QP}\NormalTok{(covariance, }\DataTypeTok{dvec=}\NormalTok{dvec, }\DataTypeTok{Amat=}\NormalTok{Amat, }\DataTypeTok{bvec=}\NormalTok{bvec, }\DataTypeTok{meq=}\NormalTok{meq)}
\NormalTok{eff[loop,}\StringTok{"Std.Dev"}\NormalTok{] <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{sum}\NormalTok{(sol}\OperatorTok{$}\NormalTok{solution }\OperatorTok{*}\KeywordTok{colSums}\NormalTok{((covariance }\OperatorTok{*}\StringTok{ }\NormalTok{sol}\OperatorTok{$}\NormalTok{solution))))}
\NormalTok{eff[loop,}\StringTok{"Exp.Return"}\NormalTok{] <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(sol}\OperatorTok{$}\NormalTok{solution }\OperatorTok{%*%}\StringTok{ }\KeywordTok{colMeans}\NormalTok{(returns))}
\NormalTok{eff[loop,}\StringTok{"sharpe"}\NormalTok{] <-}\StringTok{ }\NormalTok{eff[loop,}\StringTok{"Exp.Return"}\NormalTok{] }\OperatorTok{/}\StringTok{ }\NormalTok{eff[loop,}\StringTok{"Std.Dev"}\NormalTok{]}
\NormalTok{eff[loop,}\DecValTok{1}\OperatorTok{:}\NormalTok{n] <-}\StringTok{ }\NormalTok{sol}\OperatorTok{$}\NormalTok{solution}
\NormalTok{loop <-}\StringTok{ }\NormalTok{loop}\OperatorTok{+}\DecValTok{1}
\NormalTok{\}}
 
\KeywordTok{return}\NormalTok{(}\KeywordTok{as.data.frame}\NormalTok{(eff))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{eff.optimal.point <-}\StringTok{ }\NormalTok{eff[eff}\OperatorTok{$}\NormalTok{sharpe}\OperatorTok{==}\KeywordTok{max}\NormalTok{(eff}\OperatorTok{$}\NormalTok{sharpe),]}\OperatorTok{*}\DecValTok{100}
\NormalTok{eff.optimal.point}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{eff.optimal.point <-}\StringTok{ }\NormalTok{eff[eff}\OperatorTok{$}\NormalTok{sharpe}\OperatorTok{==}\KeywordTok{max}\NormalTok{(eff}\OperatorTok{$}\NormalTok{sharpe),]}
\KeywordTok{library}\NormalTok{(ggplot2)}
\CommentTok{# Color Scheme}
\NormalTok{ ealred  <-}\StringTok{ "#7D110C"}
\NormalTok{ ealtan  <-}\StringTok{ "#CDC4B6"}
\NormalTok{ eallighttan <-}\StringTok{ "#F7F6F0"}
\NormalTok{ ealdark  <-}\StringTok{ "#423C30"}
\KeywordTok{ggplot}\NormalTok{(eff, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Std.Dev, }\DataTypeTok{y=}\NormalTok{Exp.Return)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{alpha=}\NormalTok{.}\DecValTok{1}\NormalTok{, }\DataTypeTok{color=}\NormalTok{ealdark) }\OperatorTok{+}
\StringTok{ }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{data=}\NormalTok{eff.optimal.point, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Std.Dev, }\DataTypeTok{y=}\NormalTok{Exp.Return, }\DataTypeTok{label=}\NormalTok{sharpe), }\DataTypeTok{color=}\NormalTok{ealred, }\DataTypeTok{size=}\DecValTok{5}\NormalTok{) }\OperatorTok{+}
\StringTok{ }\KeywordTok{annotate}\NormalTok{(}\DataTypeTok{geom=}\StringTok{"text"}\NormalTok{, }\DataTypeTok{x=}\NormalTok{eff.optimal.point}\OperatorTok{$}\NormalTok{Std.Dev, }\DataTypeTok{y=}\NormalTok{eff.optimal.point}\OperatorTok{$}\NormalTok{Exp.Return,}
 \DataTypeTok{label=}\KeywordTok{paste}\NormalTok{(}\StringTok{"Risk: "}\NormalTok{, }\KeywordTok{round}\NormalTok{(eff.optimal.point}\OperatorTok{$}\NormalTok{Std.Dev}\OperatorTok{*}\DecValTok{100}\NormalTok{, }\DataTypeTok{digits=}\DecValTok{3}\NormalTok{),}\StringTok{"}\CharTok{\textbackslash{}n}\StringTok{Return: "}\NormalTok{,}
 \KeywordTok{round}\NormalTok{(eff.optimal.point}\OperatorTok{$}\NormalTok{Exp.Return}\OperatorTok{*}\DecValTok{100}\NormalTok{, }\DataTypeTok{digits=}\DecValTok{4}\NormalTok{),}\StringTok{"%}\CharTok{\textbackslash{}n}\StringTok{Sharpe: "}\NormalTok{,}
 \KeywordTok{round}\NormalTok{(eff.optimal.point}\OperatorTok{$}\NormalTok{sharpe}\OperatorTok{*}\DecValTok{100}\NormalTok{, }\DataTypeTok{digits=}\DecValTok{2}\NormalTok{), }\StringTok{"%"}\NormalTok{, }\DataTypeTok{sep=}\StringTok{""}\NormalTok{), }\DataTypeTok{hjust=}\DecValTok{0}\NormalTok{, }\DataTypeTok{vjust=}\FloatTok{1.2}\NormalTok{) }\OperatorTok{+}
\StringTok{ }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Efficient Frontier}\CharTok{\textbackslash{}n}\StringTok{and Optimal Portfolio"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x=}\StringTok{"Risk (standard deviation of portfolio variance)"}\NormalTok{, }\DataTypeTok{y=}\StringTok{"Return"}\NormalTok{) }\OperatorTok{+}
...
\includegraphics{Markowitz_Research_Me_files/figure-latex/unnamed-chunk-22-3.pdf}
...
\includegraphics{Markowitz_Research_Me_files/figure-latex/unnamed-chunk-23-3.pdf}
...
\includegraphics{Markowitz_Research_Me_files/figure-latex/unnamed-chunk-23-4.pdf}
...
\includegraphics{Markowitz_Research_Me_files/figure-latex/unnamed-chunk-23-5.pdf}
...
\includegraphics{Markowitz_Research_Me_files/figure-latex/unnamed-chunk-23-7.pdf}
...
\includegraphics{Markowitz_Research_Me_files/figure-latex/unnamed-chunk-23-8.pdf}
...
\includegraphics{Markowitz_Research_Me_files/figure-latex/unnamed-chunk-24-1.pdf}
...
\includegraphics{Markowitz_Research_Me_files/figure-latex/unnamed-chunk-24-2.pdf}
...
\includegraphics{Markowitz_Research_Me_files/figure-latex/unnamed-chunk-24-3.pdf}
...
\includegraphics{Markowitz_Research_Me_files/figure-latex/unnamed-chunk-26-1.pdf}
...
\KeywordTok{ggplot}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_bar}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ Allocation, }\DataTypeTok{x =}\NormalTok{ mu, }\DataTypeTok{fill =}\NormalTok{ Stocks), }\DataTypeTok{data =}\NormalTok{ asset_free, }\DataTypeTok{stat=}\StringTok{"identity"}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_fill_manual}\NormalTok{(}\StringTok{"Stocks"}\NormalTok{,}\DataTypeTok{values =}
                      \KeywordTok{c}\NormalTok{(}\StringTok{"FB"}\NormalTok{=}\StringTok{"#0000FF"}\NormalTok{,}\StringTok{"JNJ"}\NormalTok{=}\StringTok{"#00FF00"}\NormalTok{,}\StringTok{"BABA"}\NormalTok{=}\StringTok{"#FF0000"}\NormalTok{,}\StringTok{"DIS"}\NormalTok{=}\StringTok{"#454545"}\NormalTok{,}\StringTok{"cash"}\NormalTok{=}\StringTok{"violet"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
